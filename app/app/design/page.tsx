...
// Design-token smoke test (public): renders both-theme tokens and the UI kit.
// Replaced by proper design-system stories in Phase 2.
  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col gap-6 p-6">
      ...
      <section className="flex flex-col gap-3 rounded-lg border border-border bg-surface p-4 shadow-1">
        ...
        <Field label={t("field.label")} htmlFor="demo" help={t("field.help")}>
          <Input id="demo" placeholder={t("field.placeholder")} />
        </Field>
      </section>
    </main>
  );
